...
within the 15-17 age group. These values were then manually
...
Unsure why there is 15-17 (and 18-19) if there is already
a group for 15-19.
*/

-- All races
SELECT
  _15_17_years__percentage_ - LAG(_15_19_years__percentage_) OVER (ORDER BY Year) AS diff_curr_prev_percentage
