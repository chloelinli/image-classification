...
within the 15-19 age group. These values were then manually
...
SELECT
  Year,
  _15_19_years__percentage_ - LAG(_15_19_years__percentage_) OVER (ORDER BY Year) AS diff_curr_prev_percentage
