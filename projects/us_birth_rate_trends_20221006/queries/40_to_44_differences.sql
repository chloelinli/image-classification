...
within the 40-44 age group. These values were then manually
...
-- All races
SELECT
  _40_44_years__percentage_ - LAG(_15_19_years__percentage_) OVER (ORDER BY Year) AS diff_curr_prev_percentage
